      ...
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          mainEntity: [
            ...
            { "@type": "Question", name: "Can I pay from Egypt, Morocco, or Syria?", acceptedAnswer: { "@type": "Answer", text: "Yes — Stripe accepts cards and payment methods from virtually every country. If you have a Visa or Mastercard, you can enrol." } },
            { "@type": "Question", name: "How do I cancel my subscription?", acceptedAnswer: { "@type": "Answer", text: "Visit ssracourses.com/dashboard and enter the email you used at checkout. You can cancel in one click — no questions asked. We also offer a 14-day money-back guarantee." } },
      ...
      <section className="bg-hero pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container text-center relative reveal">
          ...
          <p className="text-white/55 text-lg max-w-xl mx-auto mb-8">
            One subscription for German language. Individual one-time payments for clinical and career courses. All orders processed by Stripe.
          </p>
        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              { icon: RefreshCcw, title: "Cancel Anytime",    desc: "Subscriptions can be cancelled any time at ssracourses.com/dashboard using your checkout email. 14-day money-back guarantee." },
        ...
        <div className="container max-w-2xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "How do I cancel my subscription?", a: "Visit ssracourses.com/dashboard and enter the email you used at checkout. You can cancel in one click — no questions asked. We also offer a 14-day money-back guarantee." },
