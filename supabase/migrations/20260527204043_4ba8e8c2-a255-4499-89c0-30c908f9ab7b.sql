...
('medical-german','Medizinisches Deutsch','الألمانية الطبية','German for Sports Scientists — Monthly',29,1595,'subscription','language',false,'Ongoing','A0→B1',1,'["Body & movement vocabulary","Clinic conversations","Written report templates","Patient explanation scripts","B1 exam preparation"]'::jsonb),
